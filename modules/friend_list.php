					...
					while ($i < $col_polzovateley) 
					{
						...
						<li>
							...
							<?php
								...
								{
									?>
								<div data-link2="http://localhost/delete_friend.php?user_id=<?php echo $polzovatel["id"];?>"onclick="del(this)">Удалить из друзей - </div>
									<?php	
								}
								else
								{
									?>
								<div data-link="http://localhost/add_friend.php?user_id=<?php echo $polzovatel["id"];?> "onclick="add(this)">Добавить в друзья + </div>
									<?php
								}
